...
- [Manipulating data](./manipulating-data.html) <span style="color:#cccccc">(to be updated)</span>
- <span style="color:#cccccc">Working with text (to be added)</span>  <!-- stringr (link to tidytext) -->
- <span style="color:#cccccc">Import and export (to be added)</span>  <!-- data formats -->
