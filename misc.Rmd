...
Sometimes it's just too much effort to set up a whole Shiny app. Maybe all you want to do is have some simple text based interaction, and you'd be perfectly happy for the user to respond at in the R console. Here's a simple example:
