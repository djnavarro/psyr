...
To see this, we can move the `print` statement inside the body of the loop so that we can see each increment take place. Let’s watch:
...
For example, this loop will print the word "hello" three times:
