...
Suppose we are creating a new survey that will consist of 30 items that that 25 seconds each, and the consent form takes 120 seconds. Create a variable `new_survey_time` that calculates how long this new survey will take. 
