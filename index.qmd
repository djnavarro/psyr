...
<div class="jumbotron"><h1 class="title toc-ignore display-3" align="center">R for Psychological Science</h1><p class="lead" align="center">by Danielle Navarro <a href="https://twitter.com/djnavarro"><i class="fab fa-twitter"></i></a></p></div>
...
- Week 1 slides: [pptx](./archive/misc/overview.pptx), [pdf](./archive/misc/overview.pdf)
- Week 2 workbook: [here](./archive/lesson2.Rmd)
- Week 3 slides: [here](https://slides.com/djnavarro/psyc-3361-workshop-3/)
- Data sets are [here](./archive/misc/data.zip)
...
- Exercises: programming with turtles ([part1](./archive/misc/turtle1.html), [part2](./archive/misc/turtle2.html))
- Week 1 slides are posted [here](./archive/misc/overview.pdf)
- Week 2 notebook is posted [here](./archive/misc/lesson2.nb.html) with output version [here](./archive/misc/lesson2.html) 
